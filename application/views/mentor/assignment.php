                 ...
                 <?php foreach ($assignment as $item) : ?>
                     ...
                     <tr class="text-sm lg:text-base">
                         ...
                         <td class="border-b px-4 py-2 flex flex-wrap items-center justify-center gap-x-2 ">
                             <!-- COLLECTION -->
                             <a href="<?=site_url('mentor/assignment_collection')?>">
                             ...
                             <!-- EDIT -->
                             <a href="#">
                                 <img class="Edit w-5 sm:w-7 cursor-pointer" data-tooltip-target="tooltipEdit" src="<?= base_url('assets/') ?>img/icons/edit_icon.svg" alt="Assignment Collection Icon" type="button">
                             </a>
                             ...
                             <!-- DELETE -->
                             <a href="">
                                 <img class="Delete w-5 sm:w-7 cursor-pointer" data-tooltip-target="tooltipDelete" src="<?= base_url('assets/') ?>img/icons/delete_icon.svg" alt="Delete Icon" onclick="return confirm('Apakah anda yakin menghapus data ini?')" type="button">
                             </a>
