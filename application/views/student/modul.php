        ...
        <div class="bg-cgray w-full h-screen px-10 py-6 flex flex-col gap-y-6 overflow-y-scroll">
            ...
            <div class="p-2 lg:p-4">
                <ul class="flex items-center gap-x-4 text-xs lg:text-base">
                    ...
                    <li>
                        <a class="text-light-green hover:text-dark-green hover:font-semibold" href="<?= site_url('dashboard/student')?>">Batch</a>
                    </li>
                    <li>
                        <span class="text-light-green">/</span>
                    </li>
            ...
            <?php foreach($modul_child as $item) { ?> 
                <!-- MEMANGGIL DAN MENAMPILKAN SELURUH SUB TOPIC YANG ADA ATAU SUDAH DIBUAT PADA COURSE YANG SEDANG DIBUKA-->
                    <a href="<?= site_url('dashboard/assignment/'.$item->id)?>" class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" data-tooltip-target="tooltip-default">
